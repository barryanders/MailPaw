  ...
  const maybeShowCoffeePrompt = () => {
    ...
    showModal('Email ready', `
      <div style="color:#475569; font-size:14px; line-height:1.5;">
        MailPaw is free, private, and local-first. If it saved you time, a small coffee helps keep tools like this available.
      </div>
    `, () => {
    ...
    showModal('MailPaw is Free', `
      <div style="color:#475569; font-size:14px; line-height:1.5;">
        ...
        <div style="margin-top:14px;">
          ...
          If MailPaw helped you, feel free to <a href="${MAILPAW_SUPPORT_URL}" target="_blank" rel="noopener" style="color:#111827; font-weight:700;">buy me a coffee</a>.
        </div>
      </div>
    `, () => true);
    const modal = document.querySelector('.zt-modal-overlay');
